# Physics-Based Animation: Affine-Body-Dynamics
In this assignment you will learn to implement affine body dynamics  for simulating stiff solid objects.
...
```
# physics-based-animation-abd-solution
